...
`lighthouse_ruined` · `crane_wrecked` · `house_office_damaged` · `ship_wrecked` (Sturm-Trümmer-Varianten v2, #690; `muted warm earthy palette`, `soft dark-tinted outlines not pure black`, `single light source top-left`, `selective outline`, `detailed shading`, `high detail`; strukturell eingestürzt — obere Hälfte abgebrochen, umgekippter Kran, eingestürztes Dach, kenterndes Schiff. `lighthouse_ruined` 44×100, `side view`; `crane_wrecked` 160×176, `high top-down`; `house_office_damaged` 102×108, `high top-down`; `ship_wrecked` 288×176, `high top-down`. Reine Asset-Registrierung; Render-Logik (wann ruined statt original) folgt in Sturm-Optik 2/4+)
