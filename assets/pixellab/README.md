...
`lighthouse_ruined` 1bccdad4 · `crane_wrecked` c5bf4223 · `house_office_damaged` ec150b96 · `ship_wrecked` 05558eea (Sturm-Trümmer-Varianten, #690; `muted warm earthy palette`, `soft dark-tinted outlines not pure black`, `single light source top-left`, `selective outline`, `detailed shading`, `high detail`; ca. 60–70 % der Original-Struktur erkennbar — Risse, eingestürzte Teile, Trümmer am Fuß. `lighthouse_ruined` 90×90, `side view`; `crane_wrecked` 160×160, `high top-down`; `house_office_damaged` 204×204, `high top-down`; `ship_wrecked` 288×288, `high top-down`. Reine Asset-Registrierung; Render-Logik (wann ruined statt original) folgt in Sturm-Optik 2/4+)
