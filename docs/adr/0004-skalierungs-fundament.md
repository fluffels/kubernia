...
- [ADR 0010 – Karten-Modell: Tiled vs. Code-Builder](0010-karten-modell-tiled-vs-code-builder.md) (#957, 2026-07-23): **zieht dieselbe Content-as-Data-Logik auf die Karten-Ebene.** Zwei Karten-Pipelines (Tiled-Daten für bespoke Karten, Code-Builder für prozedurale Regionen) bleiben bewusst nebeneinander bestehen, mit einer expliziten Grenzregel statt Konvergenz.
- [ADR 0011 – NPC-System-Fundament](0011-npc-system-fundament.md) (#963, 2026-07-24): **erweitert die hier gelegte Entity-Registry (#349) um eine zweite Achse** — statische Design-Daten (Rolle, Verhaltenszustand, Tagesplan) vs. dynamischer Spielstand (Beziehungslevel, einzige Save-Migration).
