...
| **Welt-/Präsentation** | unterstützend | Hafen-Geometrie, Karten/Regionen, Deko, Szenen-/DOM-Rendering, SFX | räumlich/Hafen (Kiste, Steg, Laterne, Insel) | `src/world.ts`/`decor.ts`/`world/regions/*`/… , `src/scenes/*`, `src/ui/*`, `src/sfx.ts` | [world.md](module/world.md) (pure) + [presentation.md](module/presentation.md) (Phaser/DOM) |
