...
|---|-------|--------|--------------|---------------------------|
| 1 | Skalierungs-Enabler | **#415** | WorldScene auf Map-Registry generalisieren + TS-Inseln datengetrieben | Neue Region ohne Copy-Paste-Szene. Baut auf #57/#193 (✓); **nach #357** (Objekt-Registry ✓) liegen auch Trigger/Objekte als Daten vor. |
