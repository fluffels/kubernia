...
| A36b | **#563** | niedrig | Burn-down #502 (sim 3/3): `sim.ts`-Kern (mergeScenario/reset/exec) | Kind von #545; der schwerste Brocken, eigener Slice. #545 (sim 1/3) + #562 (sim 2/3) erledigt. |
| A38a | **#564** | niedrig | Burn-down #502 (Präsentation 1/3): Szenen (WorldScene/RegionScene/InteriorScene/shared/main) | Kind von #547 (zu breit → 3 geteilt); Präsentations-Schicht. |
| A38b | **#565** | niedrig | Burn-down #502 (Präsentation 2/3): UI (overlay/questlog/quiz/radio) | Kind von #547; UI-Schicht. |
| A38c | **#566** | niedrig | Burn-down #502 (Präsentation 3/3): devpanel + Region-Geometrie (devpanel/archipel/lighthouse/warehouse) | Kind von #547; devpanel + Region-Geometrie. |
