...
| H2 | **#526** | hoch | Kanonische Harness-Tiefendoku `docs/agent-harness.md` (wie + warum) | Tiefenquelle, auf die #525 (Ebene 3) + arc42 verweisen. |
