...
| A2 | **#493** | hoch | Save: `importData` umgeht Migration/Sanitize + schreibt hüllenlos (`write` statt `writeState`) | „Save darf nie brechen"-Verstoß am Wiederherstellungspfad; verifiziert. |
