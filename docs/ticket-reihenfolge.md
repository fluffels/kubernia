...
| H7 | **#531** | mittel | Forum-Inbox härten (Prompt-Injection: externer Text → auto-Issue → Agent) | Einziger Pfad, auf dem unvertraute Eingaben in die Agenten-Queue gelangen. |
