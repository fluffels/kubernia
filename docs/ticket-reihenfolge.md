...
|---|--------|------|--------------|---------------------------|
| | **— Tiefer Lernpfad —** | | | |
| 1 | **#239** | niedrig | Lernbogen: Cluster nach Sturm selbst neu aufbauen (Spät-Spiel) | Content/Lernbogen, design-frei (nutzt vorhandene Sturm-Mechanik). |
