...
| | **— System / QoL —** | | | |
| 1 | **#491** | niedrig | Barrierefreiheit: farb-unabhängige Statuscodierung (Quiz ✓/✗, Fässer, Pod-Kisten) | Auto-Rest nachgefüllt (Prio→Nummer); A11y/QoL, keine Abhängigkeit. **(in Arbeit — Assignee/Worktree)** |
| | **— Anlegende / Epic —** | | | |
