...
| | **— Tiefer Lernpfad (Aufbau-Bogen #239 komplett: #460–#466 erledigt; #279 Backfill + #278 Sammelalbum + #328 Sandbox-Lernthema erledigt; #484 Scheduler-Blindplatzierung + #485 initContainer erledigt) —** | | | |
| 1 | **#486** | niedrig | Lernlücke: Image Garbage Collection (kubelet räumt Images, in-use blockt) | Lernpfad-Content; kubelet-/Node-Housekeeping neben Eviction/DiskPressure (Content vor QoL). |
| 2 | **#487** | niedrig | Lernlücke: QoS-Klassen vollständig (BestEffort/Burstable/Guaranteed) + Eviction-Prio | Lernpfad-Content; vertieft genau die requests/limits→Eviction-Reihenfolge aus #484/Knut (Content vor QoL). |
| | **— System / QoL —** | | | |
