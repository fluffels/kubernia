...
> **Stand: 2026-06-24 — nächstes Ticket: #451. Kopf: 15 Einträge. Zuletzt abgeschlossen: #447 („Kisten-Supermarkt" → „Registry" in Bos Docker-Intro), #446 (Bo-Intro „Box" → „Container"), #445 („Funkgerät" → „Terminal" in allen spielersichtbaren Texten), #444 (Pod-Security-Härtung blockiert imperative create-Übungen nicht mehr), #147 (Terraform-Konfig-Inhalte Phase 9).**
...
| 1 | **#451** | mittel | Bo-Abschluss Quest 1: direkt zu Kralle schicken statt generisch „Üben" | **Nächstes Ticket.** Didaktik; unabhängig (verwandt mit #302). |
| 2 | **#452** | mittel | Didaktik: Begriffs-Tooltips in Dialog/Kralle-Abfrage statt Mouseover | Didaktik; unabhängig. |
