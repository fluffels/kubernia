...
> **Kuratierung 2026-07-01 (arc42-Analyse, [arc42-architektur.md](arc42-architektur.md)):** neue Tickets #477–#481 angelegt. Die **DDD-Präzisierung #477/#478/#479** ist auf Maintainerin-Wunsch **ganz nach oben** kuratiert; #480 (Präsentations-Tests) als Tech-Debt eingereiht, #481 (Barrierefreiheit, niedrig) im Auto-Rest. **Nächstes freies Ticket = oberstes des Kopfes** (#477).
>
...
|---|--------|------|--------------|---------------------------|
| | **— ⭐ DDD-Präzisierung (aus arc42-Analyse 2026-07; von der Maintainerin ganz nach oben priorisiert) —** | | | |
| 1 | **#477** | hoch | Ubiquitous Language sichtbar machen (Glossar Hafen↔K8s↔Code) + Subdomänen als Kontext-Landkarte | **Token-Effizienz-Hebel** (explizites Qualitätsziel „KI entwickelt billig") + ACL sichtbar machen; Doku-lastig, keine Abhängigkeit. |
