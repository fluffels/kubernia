...
> **⭐ Kopf-Reihenfolge (Stand 2026-07-02):** Harness-&-Vorzeige-Doku (#525–#533) **und der komplette iSAQB-MITTEL-Block (#514/#498/#502–#506) sind abgearbeitet**, ebenso die Epics **#535/#536** (in Kinder zerlegt). Die **#536-Ordner-Slices sind komplett (#548/#549/#550/#551/#552 ✓)**. Der **save-kritische #535-Rename-Slice #557 ist erledigt (#553/#554/#557 ✓)** — Storage-Keys + IndexedDB-DB-Name heißen jetzt `kubernia`, Alt-Stände werden verlustfrei migriert; offen bleibt nur die Repo-URL-Nachziehung **#558** (geparkt `status:zurückgestellt`, blockiert durch die GitHub-Repo-Rename-Aktion der Maintainerin) sowie die Doku-/Build-Strings **#555/#556** (Auto-Rest niedrig). Oben steht jetzt der **NIEDRIG-God-File-Split-Block #515–#524** vor dem **Burn-down #502 (#542–#547)**, damit die Splits am fertigen Ort landen; danach der Lernpfad-/QoL-Kopf. Oberstes freies Ticket: **#515**. Volle Begründung je Ticket: [architektur-analyse-2026-07-iSAQB.md](architektur-analyse-2026-07-iSAQB.md).
