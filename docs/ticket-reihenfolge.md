...
| A3 | **#494** | hoch | Content: `scenario`/`applyEffects` per `as`-Cast ungeprüft → `reviveScenario` mit Allowlist | Größte Validierungslücke, am fehleranfälligsten Feld. |
