...
> **⭐ Kopf-Reihenfolge (Stand 2026-07-02):** Harness-&-Vorzeige-Doku (#525–#533) **und der komplette iSAQB-MITTEL-Block (#514/#498/#502–#506) sind abgearbeitet**, ebenso die Epics **#535/#536** (in Kinder zerlegt). Die **#536-Ordner-Slices sind komplett (#548/#549/#550/#551/#552 ✓)** — `src/core/`, `src/hud/`, `src/world/maps/`, `src/world/regions/` und der `src/world/`-Welt-Kern stehen. Oben stehen jetzt die **#535-Rename-Slices (#553/#554/#557 mittel; #555/#556 im Auto-Rest niedrig)** — _vor_ den NIEDRIG-God-File-Splits #515–#524 und dem **Burn-down #502 (#542–#547)**, damit die Splits am fertigen Ort landen. Danach der bisherige Lernpfad-/QoL-Kopf. Oberstes freies Ticket: **#554** (#553 gerade in Arbeit). Volle Begründung je Ticket: [architektur-analyse-2026-07-iSAQB.md](architektur-analyse-2026-07-iSAQB.md).
