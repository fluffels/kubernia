...
| 2 | **#339** | niedrig | Assets als Sprite-Maps bündeln (Texture-Atlas statt Einzel-Dateien) | Auto-Rest nachgefüllt (Prio→Nummer); System/Perf, keine Abhängigkeit. |
| 3 | **#491** | niedrig | Barrierefreiheit: farb-unabhängige Statuscodierung (Quiz ✓/✗, Fässer, Pod-Kisten) | Auto-Rest nachgefüllt (Prio→Nummer); A11y/QoL, keine Abhängigkeit. |
| | **— Anlegende / Epic —** | | | |
