...
| 1 | **#481** | niedrig | Barrierefreiheit prüfen: farb-unabhängige Statuscodierung, Tastatur-Vollbedienung, Kontraste | Heutiges arc42-Architektur-Ticket; im Block mitgezogen, unten (niedrig, keine Abhängigkeit). |
| | **— Tiefer Lernpfad (Aufbau-Bogen #239 komplett: #460–#466 erledigt; #279 Backfill + #278 Sammelalbum + #328 Sandbox-Lernthema erledigt) —** | | | |
| 2 | **#484** | mittel | Lernlücke: Scheduler platziert blind bei request=0 — Eviction-Loop vs. Pending | Neues Lernpfad-Ticket (mittel), echte K8s-Scheduling-Tiefe; steht über den niedrig-QoL/Optik-Tickets (Content vor QoL). |
| | **— System / QoL —** | | | |
