...
> **⭐ Ganz oben stehen zwei kuratierte Blöcke (2026-07-01), die von oben nach unten abgearbeitet werden:** zuerst **Harness & Vorzeige-Doku (#525–#531)**, dann die **iSAQB-Architektur-Analyse (#492–#524)** — _danach_ folgt der bisherige Lernpfad-/QoL-Kopf. Volle Begründung je Ticket: [architektur-analyse-2026-07-iSAQB.md](architektur-analyse-2026-07-iSAQB.md).

| # | Ticket | Prio | Worum's geht | Warum hier / Abhängigkeit |
|---|--------|------|--------------|---------------------------|
| | **━━━ Harness & Vorzeige-Doku 2026-07-01 (Marketing + Agenten-Harness erklären + härten) ━━━** | | | |
| H9 | **#533** | niedrig | Diff-Größenbudget als Gate (`check:diffsize`) — kleine Commits erzwingen | Aus KI-Fabrik-Analyse; Schwester von `check:size`, reiht sich ins Gate-/Tooling-Fundament (#527/#529). |
