...
| A1 | **#492** | hoch | Determinismus: zentrale seedbare RNG + Fitness-Function gegen `Math.random` in Domäne/Content | Widerspricht dem Determinismus-Anspruch; blockiert Golden-/Snapshot-Tests. Von 2 Analysen bestätigt. |
