...
> **⭐ Kopf-Reihenfolge (Stand 2026-07-02):** Harness-&-Vorzeige-Doku (#525–#533) **und der komplette iSAQB-MITTEL-Block (#514/#498/#502–#506) sind abgearbeitet**, ebenso die Epics **#535/#536** (in Kinder zerlegt). Die **#536-Ordner-Slices sind komplett (#548/#549/#550/#551/#552 ✓)** — `src/core/`, `src/hud/`, `src/world/maps/`, `src/world/regions/` und der `src/world/`-Welt-Kern stehen. Oben steht jetzt der letzte offene **#535-Rename-Slice (#553/#554 ✓; #557 mittel, save-kritisch, zuletzt; #555/#556 im Auto-Rest niedrig)** — _vor_ den NIEDRIG-God-File-Splits #515–#524 und dem **Burn-down #502 (#542–#547)**, damit die Splits am fertigen Ort landen. Danach der bisherige Lernpfad-/QoL-Kopf. Oberstes freies Ticket: **#557**. Volle Begründung je Ticket: [architektur-analyse-2026-07-iSAQB.md](architektur-analyse-2026-07-iSAQB.md).

| # | Ticket | Prio | Worum's geht | Warum hier / Abhängigkeit |
|---|--------|------|--------------|---------------------------|
| | **━━━ Rename-Slices — Kinder von #535 (MITTEL, zuerst) ━━━** | | | |
| N5 | **#557** | mittel | Rename #535 (5/5): Storage-Keys/DB-Namen + Repo-Name (save-kritisch) | Kind von #535; **oberstes freies** (nach #553/#554 ✓) und **ganz zuletzt** der Kette — Save-Format nicht brechen (migrieren). Danach #555/#556 (interne Doku/Build, niedrig, im Auto-Rest). |
