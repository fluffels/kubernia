...
| H1 | **#525** | hoch | Vorzeige-README: Spiel vermarkten + Architektur/Qualität + KI-Agenten-Harness erklären | Der Showcase-Einstieg; verlinkt Harness-Doku (#526) + arc42/Analyse. |
