...
| H4 | **#528** | hoch | Git pre-push-Hook — schnelle Gates lokal vor `git push origin main` | Schließt die einzige echte Netzlücke (Post-hoc-CI bei Direkt-Push). Nach #527 (baut auf `npm run verify` auf). |
