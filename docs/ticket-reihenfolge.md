...
> **⭐ Kopf-Reihenfolge (Stand 2026-07-02):** Harness-&-Vorzeige-Doku (#525–#533) **und der komplette iSAQB-MITTEL-Block (#514/#498/#502–#506) sind abgearbeitet**, ebenso die Epics **#535/#536** (in Kinder zerlegt). Die **#536-Ordner-Slices sind komplett (#548/#549/#550/#551/#552 ✓)** — `src/core/`, `src/hud/`, `src/world/maps/`, `src/world/regions/` und der `src/world/`-Welt-Kern stehen. Oben stehen jetzt die **#535-Rename-Slices (#553 ✓; #554/#557 mittel; #555/#556 im Auto-Rest niedrig)** — _vor_ den NIEDRIG-God-File-Splits #515–#524 und dem **Burn-down #502 (#542–#547)**, damit die Splits am fertigen Ort landen. Danach der bisherige Lernpfad-/QoL-Kopf. Oberstes freies Ticket: **#554**. Volle Begründung je Ticket: [architektur-analyse-2026-07-iSAQB.md](architektur-analyse-2026-07-iSAQB.md).

| # | Ticket | Prio | Worum's geht | Warum hier / Abhängigkeit |
|---|--------|------|--------------|---------------------------|
| | **━━━ Rename-Slices — Kinder von #535 (MITTEL, zuerst) ━━━** | | | |
| N4 | **#554** | mittel | Rename #535 (2/5): README + spielerseitige Doku → „Kubernia" | Kind von #535; **oberstes freies** (nach #553 ✓). Rename-Kette **in fester Reihenfolge 1→5**, save-kritische Storage-Keys **#557 zuletzt**. Danach #555/#556 (interne Doku/Build, niedrig, im Auto-Rest). |
