...
| | **— Tiefer Lernpfad (Aufbau-Bogen #239 komplett: #460–#466 erledigt; #279 Backfill + #278 Sammelalbum + #328 Sandbox-Lernthema erledigt; #484 Scheduler-Blindplatzierung + #485 initContainer + #486 Image-GC erledigt) —** | | | |
| 1 | **#487** | niedrig | Lernlücke: QoS-Klassen vollständig (BestEffort/Burstable/Guaranteed) + Eviction-Prio | Lernpfad-Content; vertieft genau die requests/limits→Eviction-Reihenfolge aus #484/Knut (Content vor QoL). |
| | **— System / QoL —** | | | |
