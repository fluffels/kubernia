...
Pro Runde **genau einen** Subagenten spawnen (Agent-Tool, `subagent_type: general-purpose`, `model: "sonnet"` — der Coding-Tier muss explizit gesetzt sein, sonst erbt der Subagent das Session-Modell und tippt aus einer Opus-Session heraus jedes Ticket auf Opus (#1035); Modell-Routing-Strategie: [docs/model-routing.md](../../../docs/model-routing.md)) mit sinngemäß diesem Auftrag:
