...
export const KQContent = {
  RANKS, SHOP, NPCS, SMALLTALK, DRILLS, PRACTICE, STACK_ROUNDS, POD_PACKING_ROUNDS, YAML_STRUCT_ROUNDS, ROUTING_ROUNDS, RBAC_KEYRING_ROUNDS, corruptImage, groupQuestsByTopic,
