...
export function makeDefaultState(): GameState {
  return {
    ...
    stats: { commands: 0, reviews: 0, quizRight: 0, quizWrong: 0, piratesBeaten: 0, krakenBeaten: 0, stackBest: 0, packingBest: 0, yamlstructBest: 0, routingBest: 0, rbackeyringBest: 0, krallePractice: 0 },
    lastSeen: 0,
